...
class ExampleRendering extends React.Component {
  ...
  componentDidUpdate() {
    ...
    sessionStorage.setItem(
      this.props.example.key,
      JSON.stringify(exampleStatus)
    );
  }
  ...
  render() {
    return (
      <article className={this.getArticleClassesNames()}>
        <p className="article__title" key={this.props.example.key + 'title'}>
          {this.props.example.exampleHeader}
        </p>
        <p className="article__desc" key={this.props.example.key + 'desc'}>
          {this.props.example.exampleDesc}
        </p>
        <button
          className="article__btnresult"
          key={this.props.example.key + 'result'}
          onClick={this.showResult}
        >
          {this.changeShowResultLabel()}
        </button>
        <button
          className="article__btnreset"
          key={this.props.example.key + 'reset'}
        ...
        <div className={this.getResultClassesNames()}>
          <textarea
            className="article__flexElement article__textarea article__textarea--idle"
            readOnly
            spellCheck="false"
            key={this.props.example.key + 'enyoResult'}
            value={this.props.example.resultEnyo}
          />
          <textarea
            className="article__flexElement article__textarea article__textarea--idle"
            readOnly
            spellCheck="false"
            key={this.props.example.key + 'cssResult'}
            value={this.props.example.resultCSS}
          />
        </div>
        <p className="article__subtitle article__subtitle--enyo">
          Enyo Component
        </p>
        <p className="article__subtitle article__subtitle--css">CSS Classes</p>
        <textarea
          className={this.getEnyoClassesNames()}
          spellCheck="false"
          key={this.props.example.key + 'enyo'}
          onKeyDown={this.addTabOnTextArea}
          onChange={this.setEnyoState}
          value={this.state.enyo}
        />
        <textarea
          className={this.getCSSClassesNames()}
          spellCheck="false"
          key={this.props.example.key + 'css'}
          onKeyDown={this.addTabOnTextArea}
          onChange={this.setCSSState}
          value={this.state.css}
        />
        <button
          className="article__btn"
          key={this.props.example.key + 'check'}
    ...
    return (
      <div className="cssnaming">
        {examples().map(example => (
          <ExampleRendering key={example.key} example={example} />
        ))}
      </div>
    );
  }
